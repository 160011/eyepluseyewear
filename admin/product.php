                                            ...
                                            <form action="product_process.php" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="productname" class="form-control" id="exampleInputEmail1" placeholder="Enter Product">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <label for="productdesc">Product Description </label>
                                                        <input type="text"  name="productdesc" class="form-control" id="exampleInputEmail1" placeholder="Enter product Description">
                                                         
                                                   </div>
                                                    <div class="form-group">
                                                        <label>Select categorys</label>
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($res)) {
                                                    ...
                                                    $cattrow = mysqli_fetch_assoc($cattres);
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $catcount; ?>
                                                        ...
                                                        <td><?php echo $cattrow['categoryname']; ?></td>
