        ...
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">The contact form is currently inactive.  <a href="https://htmlcodex.com/contact-form">Download</a>.</p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex border-bottom pb-3 mb-3">
                        ...
                        <div class="ms-3">
                            <h6>Eye+ Eyewear</h6>
                            <span>Radha Krishna Complex,Rajkot, Gujarat.</span>
                        </div>
                    </div>
                    <div class="d-flex border-bottom pb-3 mb-3">
                        <div class="flex-shrink-0 btn-square bg-secondary rounded-circle">
                    ...
                    <div class="d-flex border-bottom-0 pb-3 mb-3">
                        ...
                        <div class="ms-3">
                            <h6>Mail Us</h6>
                            <span>Eye+eyewear@gmail.com</span>
                        </div>
                    </div>  
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-white mb-4">Eye+ Eyewear Office</h5>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Radha Krishna Complex, Rajkot, Gujarat</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>THis is for our customers. It is for the customers help.</p>
